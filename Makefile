...
install-perlModules:
	...
	for package in Config::Simple File::Slurp Math::Round Number::Range Statistics::Distributions Statistics::Descriptive Statistics::Normality Graph::Centrality::Pagerank String::Escape; do\
